    ...
    <div className="grid gap-1.5">
      ...
      >
        {leadingIcon && (
          <span
            ...
            className={[
              ...
              showError
                ? "text-red-300"
                : "text-emerald-200/70 group-focus-within:text-emerald-200",
            ].join(" ")}
          >
            {leadingIcon}
          </span>
        ...
        <input
          ...
          {...inputProps}
          className={[
            "csucc-float-input peer block w-full bg-transparent text-[13px] text-emerald-50 outline-none",
        ...
        <label
          ...
          className={[
            ...
            "top-3.5 text-[12px] text-emerald-200/55",
            /* When the input is unfocused AND empty, the placeholder-shown
               is true, so the label sits low. */
            "peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-[12.5px] peer-placeholder-shown:text-emerald-200/55",
            ...
            "peer-focus:bg-[#04140a] peer-focus:text-emerald-200",
            "peer-[:not(:placeholder-shown)]:-top-2 peer-[:not(:placeholder-shown)]:left-3 peer-[:not(:placeholder-shown)]:px-1.5 peer-[:not(:placeholder-shown)]:text-[10px] peer-[:not(:placeholder-shown)]:font-semibold peer-[:not(:placeholder-shown)]:uppercase peer-[:not(:placeholder-shown)]:tracking-[0.18em] peer-[:not(:placeholder-shown)]:bg-[#04140a] peer-[:not(:placeholder-shown)]:text-emerald-200/85",
      ...
      {error ? (
        ...
        <span className="pl-1 text-[10.5px] text-emerald-200/45">{hint}</span>
      ) : null}
    </div>
  );
}
