...
export function Dashboard() {
  const { states, predictions, alerts, lastTick, tickMs } = useRestroomData();
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <section className="lg:col-span-8">
            <div className="relative h-[460px] overflow-hidden rounded-2xl border border-white/10 bg-slate-900/40 backdrop-blur-md lg:h-[560px]">
              <CampusMap states={states} selectedId={selectedId} onSelect={setSelectedId} />
            ...
            <div className="mt-4 hidden lg:block">
              ...
              <StatusCards states={states} onSelect={setSelectedId} selectedId={selectedId} />
            </div>
          </section>
          ...
          <aside className="space-y-4 lg:col-span-4">
            <Panel>
              <AIPanel states={states} predictions={predictions} onSelect={setSelectedId} />
            </Panel>
            <Panel className="h-[280px]">
              <AlertFeed alerts={alerts} onSelect={setSelectedId} />
            </Panel>
          </aside>
          ...
          <section className="lg:col-span-7">
            <Panel>
              ...
              <Rankings states={states} onSelect={setSelectedId} />
            </Panel>
          </section>
